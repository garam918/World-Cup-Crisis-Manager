...
export interface SingleSimulationResult { seed:number;finalScore:Score;missionSuccess:boolean;timeline:SimulationEvent[];userGoals:number;opponentGoals:number }
...
export interface SimulationResult {
  ...
  monteCarloRuns:number;representativeSeed:number
}
