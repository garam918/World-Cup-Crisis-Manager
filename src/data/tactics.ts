...
export const defaultInstructions:TacticalInstructions={defensiveLine:'medium',pressingIntensity:'medium',tempo:'balanced',attackDirection:'balanced',riskLevel:'balanced'}
